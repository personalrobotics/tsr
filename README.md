# Task Space Regions [![Build Status](https://travis-ci.com/personalrobotics/tsr.svg?token=1MmAniN9fkMcwpRUTdFq&branch=master)](https://travis-ci.com/personalrobotics/tsr)
