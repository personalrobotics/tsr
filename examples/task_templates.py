...
def main():
    ...
    show_template("1. Grasp", "grasps", "screwdriver_grasp.yaml",
                  screwdriver_pose, "screwdriver")
    show_template("2. Drive screw", "tasks", "drive_screw.yaml",
                  screw_pose, "screw")
    show_template("3. Drop in toolchest", "places", "toolchest_drop.yaml",
                  toolchest_pose, "toolchest")
    ...
    show_template("1. Grasp mug", "grasps", "mug_handle_grasp.yaml",
                  mug_pose, "mug")
    show_template("2. Transport upright", "tasks", "mug_transport_upright.yaml",
                  mug_pose, "mug")
    show_template("3. Pour into sink", "tasks", "mug_pour_into_sink.yaml",
                  sink_pose, "sink")
    show_template("4. Place on table", "places", "mug_on_table.yaml",
                  table_pose, "table")
